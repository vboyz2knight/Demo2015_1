...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <!-- Dialogs for Test button-->
    <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel2">We'd Love to Hear From You</h3>
        </div>
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel">Upload your file[s] with extension *.csv.</h4>
            </div>
            ...
            <form id="uploadForm" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-md-4">
                            <asp:FileUpload ID="FileUpload1" runat="server" AllowMultiple="true" ClientIDMode="Static"></asp:FileUpload>
                        </div>
                        <div class="col-md-4"><span class="error">Only file[s] with extension *.csv are allow at this time.</span></div>
                    </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="submit" ID="btnUploadFiles" class="btn btn-primary" >Add Data</button>
                <!--<asp:Button type="button" data-dismiss="modal" ID="btnUploadFiles" runat="server" class="btn btn-primary" Text="Add Data" /> -->
            </form>
            </div>
        </div>
        </div>
    ...
    <script src="/SpendingAnalyzer/UploadFiles.js"></script>
